<html style="margin: 0px; padding: 0px; height: 100%;" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <style type="text/css">
        .main,.mso{background-color:#f7f7f7}.logo a:hover,.logo a:focus{color:#1e2e3b !important}.footer-logo a:hover,.footer-logo a:focus{color:#372d1b !important}.mso .layout-has-border{border-top:1px solid #c4c4c4;border-bottom:1px solid #c4c4c4}.mso .layout-has-bottom-border{border-bottom:1px solid #c4c4c4}.mso .border{background-color:#c4c4c4}.mso h1{}.mso h1{font-size:64px !important;line-height:68px !important}.mso h2{}.mso h2{font-size:48px !important;line-height:54px !important}.mso h3{}.mso h3{font-size:24px !important;line-height:32px !important}.mso .layout__inner{}.mso .layout__inner{font-size:18px !important;line-height:26px !important}.mso .footer__share-button p{}.mso .footer__share-button p{font-family:Verdana,sans-serif}
    ...
    <![endif]-->
    <!--[if !mso]><!-->
<body class="main no-padding" style="margin: 0px; padding: 0px; text-size-adjust: 100%;">
<!--<![endif]-->
<table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f7f7f7;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
            <div role="banner">
                <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 167440px);">
                    <div style="border-collapse: collapse;display: table;width: 100%;">
                        ...
                        <div class="snippet" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #1562a0;font-family: Verdana,sans-serif;">

                        </div>
                        <!--[if mso]></td><td style="width: 280px" valign="top"><![endif]-->
                        <div class="webversion" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #1562a0;font-family: Verdana,sans-serif;">
            ...
            <div>
                <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #2e9145;">
                        <!--[if mso]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-fixed-width" style="background-color: #2e9145;"><td style="width: 600px" class="w560"><![endif]-->
                        <div class="column" style="text-align: left;color: #222;font-size: 17px;line-height: 26px;font-family: Verdana,sans-serif;">
                        ...
                        <div class="column" style="text-align: left;color: #222;font-size: 17px;line-height: 26px;font-family: Verdana,sans-serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;Margin-bottom: 20px;" align="center">
                                    <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #2170b0;" href="" target="_blank"><img style="border: 0;display: block;height: auto;width: 100%;max-width: 127px;" alt="{{ config('app.name') }}" width="127" src="{{ asset('resources/images/Ehalal.png') }}"></a>
                                </div>
                            </div>
                        ...
                        <div class="column" style="text-align: left;color: #222;font-size: 17px;line-height: 26px;font-family: Verdana,sans-serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h1 class="size-24" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #609dd5;font-size: 20px;line-height: 28px;text-align: left;" lang="x-size-24"><strong><span style="text-decoration: inherit;color: #214f9a;">HalEx Registration Email Verification</span></strong></h1>
                                </div>
                            </div>

                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p class="size-14" style="Margin-top: 0;Margin-bottom: 20px;font-size: 14px;line-height: 21px;text-align: left;" lang="x-size-14"><span style="text-decoration: inherit;color: #414042;">Dear {{ $name }},</span></p>
                                </div>
                            </div>

                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p class="size-14" style="Margin-top: 0;Margin-bottom: 20px;font-size: 14px;line-height: 21px;" lang="x-size-14"><span style="text-decoration: inherit;color: #414042;">Welcome to HalEx, the largest online B2B Halal Exchange for the global Halal
                                industry powered by ICHS! We're excited to have you join our growing community
                                of halal-verified businesses.</span></p>
                                    <p class="size-14" style="Margin-top: 0;Margin-bottom: 20px;font-size: 14px;line-height: 21px;" lang="x-size-14"><span style="text-decoration: inherit;color: #414042;">To complete your registration, please use the following Verification Code:</span></p>
                                </div>
                            </div>

                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p class="size-24-m" style="Margin-top: 0;Margin-bottom: 0;font-size: 20px;line-height: 40px;text-align: center;" lang="x-size-24">{{ $otpCode }}</p>
                                </div>
                            </div>
                ...
                <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;">
                        ...
                        <div class="column" style="text-align: left;color: #222;font-size: 17px;line-height: 26px;font-family: Verdana,sans-serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p class="size-14" style="Margin-top: 0;Margin-bottom: 20px;font-size: 14px;line-height: 21px;" lang="x-size-14"><span style="text-decoration: inherit;color: #414042;">For your security, this code expires in 15 minutes. Please do not share it with anyone.</span></p>
                                    <p class="size-14" style="Margin-top: 0;Margin-bottom: 20px;font-size: 14px;line-height: 21px;" lang="x-size-14"><span style="text-decoration: inherit;color: #414042;">If you have any trouble verifying your email address, please don’t hesitate to contact us at info@ic-halal.com. If you didn’t request this, please ignore this email.</span></p>
                                </div>
                            </div>

                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p class="size-14" style="Margin-top: 0;Margin-bottom: 20px;font-size: 14px;line-height: 21px;" lang="x-size-14"><span style="text-decoration: inherit;color: #414042;">Thanks for joining HalEx, your gateway to the Global Halal Market!<br><b>The HalEx Team</b></span></p>
                                </div>
                            </div>
            ...
            <div role="contentinfo"><div style="line-height:12px;font-size:12px;" id="footer-top-spacing">&nbsp;</div><div class="layout email-flexible-footer email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;" id="footer-content">
                    <div class="layout__inner left-aligned-footer flexible-footer--horizontal-padding" style="border-collapse: collapse;display: table;width: calc(100% - 40px);margin: 0 auto;">
                        ...
                        <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #1562a0;font-family: Verdana,sans-serif;display: none;">
                ...
                </div><div style="line-height:12px;font-size:12px;" id="footer-bottom-spacing">&nbsp;</div></div>
